...
Lastly: Showcasing the full usage of the computational framework developed, we present a simple\textemdash proof of concept\textemdash MD simulation using the ANN potential for \ce{H2} in the gas state using LAMMPS.
...
The previous example showcases beautifully the fundamental problem inherent in the former approach: the efficacy of the algorithm is fundamentally limited by the human programmers ability to 
